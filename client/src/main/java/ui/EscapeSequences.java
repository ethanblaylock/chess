...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_DARK_GREY = SET_TEXT_COLOR + "239m";
    ...
    public static final String RESET_TEXT_COLOR = ANSI_ESCAPE + "[39m";

    public static final String SET_BG_COLOR_BLACK = SET_BG_COLOR + "0m";
    public static final String SET_BG_COLOR_LIGHT_GREY = SET_BG_COLOR + "230m";

    public static final String SET_BG_COLOR_GREY = SET_BG_COLOR + "253m";
    ...
    public static final String SET_BG_COLOR_GREEN = SET_BG_COLOR + "107m";
    ...
    public static final String RESET_BG_COLOR = ANSI_ESCAPE + "[49m";
